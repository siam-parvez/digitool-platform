                ...
                <div className='hero-content flex-col lg:flex-row-reverse'>
                    ...
                    <div className='space-y-2 lg:space-y-3'>
                        ...
                        <div className='flex gap-2'>
                            <a
                                href="#products"
                                className='btn btn-primary rounded-full border-none bg-linear-45 from-[#4F39F6] to-[#9514FA] hover:opacity-90 transition-opacity duration-300'>
                                Explore Products
                            </a>
                            <button
                                className='btn btn-outline rounded-full hover:opacity-90 transition-all duration-300 btn-primary'>
