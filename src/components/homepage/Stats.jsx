...
const Stats = () => {
  return (
    <section className='my-16 lg:my-32 flex items-center justify-center bg-linear-45 from-[#4F39F6] to-[#9514FA] '>
      <div className='stats stats-vertical lg:stats-horizontal w-full container mx-auto text-white py-8'>
        <div className='stat place-items-center py-6 border-white'>
