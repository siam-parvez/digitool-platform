    ...
    return (
        <div className='card w-full bg-base-100 shadow-sm border border-neutral-200 relative'>
            ...
            <div className='card-body flex flex-col gap-6 justify-between'>
                ...
                <button
                    type='button'
                    className='btn btn-primary btn-block rounded-full border-none bg-linear-45 from-[#4F39F6] to-[#9514FA] hover:opacity-90 transition-opacity duration-300 disabled:text-neutral-200 disabled:opacity-70'
